...
// 3. Optional: Dynamic aggregation metric queries can be processed here if you want to connect database items to your share indicators later
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>SOCCERSHOES XI - Statistic Metrics</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex">
  ...
  <aside class="w-72 bg-[#00C853] text-white flex flex-col justify-between p-6 shrink-0 rounded-r-[2rem] shadow-xl">
    <div>
      ...
      <nav class="space-y-1.5">
        ...
        <a href="../php/statistic.php" class="flex items-center gap-4 px-5 py-3.5 bg-white text-[#00C853] rounded-2xl shadow-md font-bold text-xs tracking-wide relative">
  ...
  <main class="flex-1 p-8 overflow-y-auto max-w-[1400px] mx-auto w-full">
    <header class="flex justify-between items-start mb-8">
      <div>
        <div class="flex items-center gap-2">
          ...
          <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Brand Performance Statistics</h1>
        </div>
        <p class="text-[11px] text-[#00C853] font-bold tracking-wide mt-0.5 ml-3.5">MARKET PENETRATION SHARE</p>
      </div>
    ...
    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm max-w-2xl">
      <h3 class="text-xs font-extrabold text-slate-900 tracking-wide uppercase mb-6">Volume Shared By Brand Entity</h3>
      <div class="space-y-4">
        <div>
          <div class="flex justify-between text-xs font-bold text-slate-700 mb-1"><span>Nike Football</span><span>54%</span></div>
          <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden"><div class="bg-[#00C853] h-full rounded-full" style="width: 54%"></div></div>
        </div>
        <div>
          <div class="flex justify-between text-xs font-bold text-slate-700 mb-1"><span>Adidas Soccer</span><span>38%</span></div>
          <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden"><div class="bg-slate-800 h-full rounded-full" style="width: 38%"></div></div>
        </div>
        <div>
          <div class="flex justify-between text-xs font-bold text-slate-700 mb-1"><span>Puma Performance</span><span>8%</span></div>
          <div class="w-full bg-slate-100 h-2 rounded-full overflow-hidden"><div class="bg-slate-300 h-full rounded-full" style="width: 8%"></div></div>
        </div>
      </div>
    </div>
  </main>
